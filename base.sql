...
#
# Data for table "base_article_class"
#

/*!40000 ALTER TABLE `base_article_class` DISABLE KEYS */;
INSERT INTO `base_article_class` VALUES (1,0,'默认分类',0);
/*!40000 ALTER TABLE `base_article_class` ENABLE KEYS */;

#
# Structure for table "base_article_data"
#
...
#
# Data for table "base_article_data"
#

/*!40000 ALTER TABLE `base_article_data` DISABLE KEYS */;
INSERT INTO `base_article_data` VALUES (1,'<p>欢迎使用base个人博客程序，当前版本为：base v1.50.20160329</p><p>这是一篇测试文章，如果有什么疑问可以访问 <a title=\"base个人博客\" target=\"_self\" href=\"http://base.com\">base个人博客</a><br/></p>');
/*!40000 ALTER TABLE `base_article_data` ENABLE KEYS */;
...
#
# Structure for table "base_user_admin"
#

DROP TABLE IF EXISTS `base_user_admin`;
CREATE TABLE `base_user_admin` (
...
#
# Data for table "base_user_admin"
#

/*!40000 ALTER TABLE `base_user_admin` DISABLE KEYS */;
INSERT INTO `base_user_admin` VALUES (1,1,1,'admin','21232f297a57a5a743894a0e4a801fc3',NULL,NULL,NULL,1459157368,'0.0.0.0','Win 10');
/*!40000 ALTER TABLE `base_user_admin` ENABLE KEYS */;
