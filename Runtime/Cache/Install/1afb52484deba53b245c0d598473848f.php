    ...
    <table class="table">
        ...
        <tbody>
            <?php if(is_array($env)): $i = 0; $__LIST__ = $env;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><i class="glyphicon glyphicon-<?php echo ($item[4]); ?> text-<?php if($item["4"] == 'ok'): ?>success<?php else: ?>danger<?php endif; ?>">&nbsp;</i><?php echo ($item[3]); ?></td>       
    ...
    <table class="table">
        ...
        <tbody>
            <?php if(is_array($func)): $i = 0; $__LIST__ = $func;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><i class="glyphicon glyphicon-<?php echo ($item[2]); ?> text-<?php if($item["2"] == 'ok'): ?>success<?php else: ?>danger<?php endif; ?>">&nbsp;</i><?php echo ($item[1]); ?></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
    </table>
