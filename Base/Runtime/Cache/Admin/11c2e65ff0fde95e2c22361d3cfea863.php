...
<article id="main-right1" class="col-md-10">
    ...
    <form action="<?php echo U('Articleclass_operat');?>" method="get" >
    <nav class="nav-title">
    ...
    <table id="list-article-class" class="table table-striped text-center">
        ...
        <?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$classData): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><input type="text" class="form-control text-center" name="ar_parent<?php echo ($classData['ar_class']); ?>" value="<?php echo ($classData['ar_parent']); ?>" maxlength="10" required /></td>
    ...
    function operat(obc,id,select){
        ...
        $.get("<?php echo U('Articleclass_operat');?>",{id:id,value:value,link:link},function(state){
