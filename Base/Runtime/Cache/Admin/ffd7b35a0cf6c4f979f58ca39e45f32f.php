...
<article id="main-right">
    ...
    <!-- 编辑器 -->
    <script type="text/javascript" charset="utf-8" src="/app/Public/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/app/Public/ueditor/ueditor.all.min.js"></script>
    <nav class="nav-title">
