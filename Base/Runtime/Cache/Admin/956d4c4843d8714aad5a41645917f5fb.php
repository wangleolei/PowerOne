...
<html lang="en" class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="/powerone/Public/admin/css/reset.css">
        <link rel="stylesheet" href="/powerone/Public/admin/css/supersized.css">
        <link rel="stylesheet" href="/powerone/Public/admin/css/style.css">
        <script src="/powerone/Public/admin/js/jquery-1.11.0.min.js" ></script>
        <script src="/powerone/Public/admin/js/supersized.3.2.7.min.js" ></script>
        <script src="/powerone/Public/admin/js/scripts.js" ></script>
    </head>
    <body>
        ...
        <script>
            ...
            $.supersized({
                ...
                slides             : [    // 幻灯片影像
                                         {image : "/powerone/Public/admin/img/1.jpg"},
                                         {image : "/powerone/Public/admin/img/2.jpg"},
                                         {image : "/powerone/Public/admin/img/3.jpg"}
                               ]
                });
            });
        </script>
