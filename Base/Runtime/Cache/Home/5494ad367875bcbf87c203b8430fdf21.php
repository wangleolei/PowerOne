...
<head>
    ...
    <!-- seo标签、基础参数 -->
    <title>博文之柜<?php if($site['site_name_suffix']): ?>- <?php echo ($site['site_name_suffix']); endif; ?></title>
...
<header class="main-header container hidden-xs">
    <h4><i class="glyphicon glyphicon-book"></i><small>博文之柜</small></h4>
...
<section class="main-content container">
    ...
    <div class="module">
        <div class="module-title-2"><b>Column</b><small>文章栏目</small><span><i class="glyphicon glyphicon-share-alt"></i>查看特定栏目文章</span></div>
