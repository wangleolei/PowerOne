...
<header class="main-header container hidden-xs">
    <h4><i class="glyphicon glyphicon-home"></i><small>站点首页</small></h4>
...
<section class="main-content container">
    ...
    <div class="module">
        <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$articleData): $mod = ($i % 2 );++$i;?><article class="module-article-img1">
            ...
            <header class="hidden-xs"><a href="<?php echo U('/article/'.$articleData['ar_id']);?>"><img src="<?php echo ($site['site_url']); echo ($site['site_catalog']); echo ($articleData['ar_cover_img']); ?>" alt="<?php echo ($articleData['ar_title']); ?>_封面" /></a></header>
            <footer>
    ...
    <div class="module text-center"><a href="<?php echo U('/articles');?>" class="btn btn-warning">点此查看更多</a></div>
</div>
</section>
